...
'#chat-bridge-root.cb-root{position:fixed!important;right:0!important;top:0!important;bottom:0!important;left:auto!important;width:var(--cb-panel-width)!important;max-width:100vw!important;background:#0d0d0d!important;color:#ddd!important;z-index:99999!important;display:flex!important;flex-direction:column!important;border-left:1px solid #2a2a2a!important;font-size:var(--cb-font-size)!important;transition:transform 0.25s ease!important;box-shadow:-4px 0 20px rgba(0,0,0,0.5)!important;transform:translateX(0)!important;}\n'+
'#chat-bridge-root.cb-root.collapsed{transform:translateX(calc(var(--cb-panel-width) - 15px))!important;}\n'+
'.cb-grabber{position:absolute!important;left:-15px!important;top:0!important;bottom:0!important;width:15px!important;background:#141414!important;border-radius:4px 0 0 4px!important;cursor:pointer!important;display:none!important;writing-mode:vertical-rl!important;text-orientation:mixed!important;color:#888!important;font-size:calc(var(--cb-font-size) - 2px)!important;text-align:center!important;align-items:center!important;justify-content:center!important;border:1px solid #2a2a2a!important;border-right:none!important;user-select:none!important;z-index:10!important;}\n'+
'.cb-grabber:hover{background:#1f1f1f!important;color:#fff!important;}\n'+
'#chat-bridge-root.cb-root.collapsed .cb-grabber{display:flex!important;}\n'+
...
'.cb-check{display:flex;align-items:center;gap:4px;margin-bottom:3px;font-size:calc(var(--cb-font-size) - 2px);color:#aaa;cursor:pointer;}\n'+
'.cb-check input{margin:0;accent-color:#7c3aed;}\n'+
